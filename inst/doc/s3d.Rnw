...
\vspace{22 mm}{\large Uwe Ligges and Martin Mächler}\vspace{7 mm}

\emph{\small \begin{tabular}{c@{\extracolsep{5mm}}cc}
Fachbereich Statistik       &  & Seminar für Statistik\\
...
Ligges, U. and Mächler, M. (2003): Scatterplot3d -- an \RR\ Package for Visualizing Multivariate Data.
